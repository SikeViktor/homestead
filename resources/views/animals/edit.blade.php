                        ...
                        <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    {{-- Animal's alive --}}
                                    <fieldset>
                                        <legend class="text-sm font-semibold leading-6 text-gray-900">Állat él
                                        </legend>
                                        <p class="mt-1 text-sm leading-6 text-gray-600">Él e még az állatod?
                                        </p>
                                        <div class="mt-6 space-y-6">
                                            <div class="flex items-center gap-x-3">
                                                <input id="alive" name="alive" type="radio"
                                                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                <label for="alive"
                                                    class="block text-sm font-medium leading-6 text-gray-900">
                                            ...
                                            <div class="flex items-center gap-x-3">
                                                <input id="dead" name="dead" type="radio"
                                                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                <label for="dead"
                                                    class="block text-sm font-medium leading-6 text-gray-900">
